...
import { Flex, Title, Text, Group, SegmentedControl, ActionIcon, Anchor } from '@mantine/core';
...
export function Header({ viewMode, onViewModeChange }: HeaderProps) {
  ...
  return (
    ...
    >
      ...
      <Group component="nav" gap="md" role="navigation" aria-label="View controls">
        {/* View mode toggle */}
        <SegmentedControl
          value={viewMode}
          onChange={(value) => onViewModeChange(value as '3d' | '2d')}
          data={[
